...
guess_package_name() {
	...
	# PTk 5 packages
		...
		PTKpcihsm2*)
			echo "SafeNet PCI-E2 HSM Access Provider (Device Driver)";;
		PTKfmsdk*)
...
initialise_globals() {
	...
	HSM_LINK_LABELSv5="PTKpcihsm2 PTKnethsm"
...
set_ptk4_paths() {
	export BASENAME=$BASENAMEv4
	export LINKBASE=$LINKBASEv4

	export LEGAL_CRYPTOKIS=$LEGAL_CRYPTOKISv4
	export CRYPTOKI_LABELS=$CRYPTOKI_LABELSv4
	export DEFAULT_CRYPTOKI_LINK=$DEFAULT_CRYPTOKI_LINKv4
	export DEFAULT_CRYPTOKI_LINK64=$DEFAULT_CRYPTOKI_LINK64v4

	export LEGAL_HSM_LINKS=$LEGAL_HSM_LINKSv4
	export HSM_LINK_LABELS=$HSM_LINK_LABELSv4
	export DEFAULT_HSM_LINK=$DEFAULT_HSM_LINKv4
	export DEFAULT_HSM_LINK64=$DEFAULT_HSM_LINK64v4
}

set_ptk5_paths() {
	export BASENAME=$BASENAMEv5
	export LINKBASE=$LINKBASEv5

	export LEGAL_CRYPTOKIS=$LEGAL_CRYPTOKISv5
	export CRYPTOKI_LABELS=$CRYPTOKI_LABELSv5
	export DEFAULT_CRYPTOKI_LINK=$DEFAULT_CRYPTOKI_LINKv5
	export DEFAULT_CRYPTOKI_LINK64=$DEFAULT_CRYPTOKI_LINK64v5

	export LEGAL_HSM_LINKS=$LEGAL_HSM_LINKSv5
	export HSM_LINK_LABELS=$HSM_LINK_LABELSv5
	export DEFAULT_HSM_LINK=$DEFAULT_HSM_LINKv5
	export DEFAULT_HSM_LINK64=$DEFAULT_HSM_LINK64v5
}
...
usage() {
	...
	echo
	echo "Support is available at support@safenet-inc.com"
	echo
}
...
echo "a legal agreement between you and SafeNet Inc."
