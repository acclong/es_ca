...
namespace SignPackage.Cryptography.Xml
{
    using System;
    ...
    using SignPackage.Cryptography;
    using System.Security;
    using System.Security.Cryptography.Xml;
    using eToken;
    //using AsymmetricSignatureFormatter = SignPackage.Cryptography.AsymmetricSignatureFormatter;
    //using SignatureDescription = SignPackage.Cryptography.SignatureDescription;
    ...
    public class SignedXml {
        ...
        public void ComputeSignature() {
            ...
            ////TOANTK: check PRIVATE KEY để lấy phương thức ký SignatureMethod
            //if (key == null)
            ...
            // See if there is a signature description class defined in the Config file: http://www.w3.org/2000/09/xmldsig#rsa-sha1
            ...
            //TOANTK: Ký chuỗi hash bằng USB Token
            ...
            ////TOANTK: Kí chuỗi hash bằng HSM
            ////IN = hashvalue
            ////OUT = m_signature.SignatureValue
            //string sOID = CryptoConfig.MapNameToOID(hashAlg.ToString());
            //m_signature.SignatureValue = HSMSignatureProcessor.SignHash(hashAlg.Hash, sOID);
        }
        ...
        private bool CheckSignedInfo (AsymmetricAlgorithm key) {
            ...
            SignatureDescription signatureDescription = System.Security.Cryptography.CryptoConfig.CreateFromName(SignatureMethod) as SignatureDescription;
            if (signatureDescription == null)
                throw new CryptographicException(SecurityResources.GetResourceString("Cryptography_Xml_SignatureDescriptionNotCreated"));
