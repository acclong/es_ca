...
namespace SignPackage.Cryptography.Xml
{
    ...
    //using CryptoConfig = SignPackage.Cryptography.CryptoConfig;
        ...
        public Transform CanonicalizationMethodObject {
            get {
                if (m_canonicalizationMethodTransform == null) {
                    object obj = new SignPackage.Cryptography.Xml.XmlDsigC14NTransform();//CryptoConfig.CreateFromName(this.CanonicalizationMethod);
