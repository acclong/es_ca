...
using SignedXml = esDigitalSignature.Package.Cryptography.Xml.SignedXml;
using Signature = esDigitalSignature.Package.Cryptography.Xml.Signature;
...
using TransformChain = esDigitalSignature.Package.Cryptography.Xml.TransformChain;
using KeyInfo = esDigitalSignature.Package.Cryptography.Xml.KeyInfo;
