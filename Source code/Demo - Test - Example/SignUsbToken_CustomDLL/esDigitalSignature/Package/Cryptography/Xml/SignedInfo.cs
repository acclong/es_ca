...
namespace esDigitalSignature.Package.Cryptography.Xml
{
    ...
    //using CryptoConfig = esDigitalSignature.Package.Cryptography.CryptoConfig;
        ...
        public Transform CanonicalizationMethodObject {
            get {
                if (m_canonicalizationMethodTransform == null) {
                    object obj = new esDigitalSignature.Package.Cryptography.Xml.XmlDsigC14NTransform();//CryptoConfig.CreateFromName(this.CanonicalizationMethod);
                    m_canonicalizationMethodTransform = obj as Transform;
                    if (m_canonicalizationMethodTransform == null)
