...
namespace esDigitalSignature.Package.Cryptography.Xml
{
    ...
    using esDigitalSignature.Package.Cryptography.X509Certificates;
    ...
    public class KeyInfo : IEnumerable
    {
        ...
        internal XmlElement GetXml(XmlDocument xmlDocument)
        {
            ...
            for (int i = 0; i < m_KeyInfoClauses.Count; ++i)
            {
                ...
                //Thay hàm internal ở dòng 182 bằng code
                XmlElement keyInfo = ((KeyInfoClause)m_KeyInfoClauses[i]).GetXml();
                XmlElement xmlElement = (XmlElement)xmlDocument.ImportNode(keyInfo, true);
        ...
        public void LoadXml(XmlElement value)
        {
            ...
            while (child != null)
            {
                ...
                if (elem != null)
                {
                    ...
                    KeyInfoClause keyInfoClause = (KeyInfoClause)System.Security.Cryptography.CryptoConfig.CreateFromName(kicString);
