...
namespace esDigitalSignature.iTextSharp.text {
    ...
    public sealed class Version {
	     ...
	     */
	    static private String iText = "esDigitalSignature.iTextSharp\u2122";
    	
	    /**
	     * This String contains the version number of this iText release.
	     * For debugging purposes, we request you NOT to change this constant.
	     */
        static private String release = "5.5.3";
        ...
        public static Version GetInstance() {
            if (version == null) {
                ...
                lock (version) {
                    try {
                        Type type = Type.GetType("esDigitalSignature.iTextSharp.license.LicenseKey, esDigitalSignature.iTextSharp.LicenseKey");
