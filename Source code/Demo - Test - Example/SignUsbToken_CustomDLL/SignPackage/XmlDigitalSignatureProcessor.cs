...
using SignedXml = SignPackage.Cryptography.Xml.SignedXml;
using Signature = SignPackage.Cryptography.Xml.Signature;
using DataObject = SignPackage.Cryptography.Xml.DataObject;
using Reference = SignPackage.Cryptography.Xml.Reference;
using TransformChain = SignPackage.Cryptography.Xml.TransformChain;
using KeyInfo = SignPackage.Cryptography.Xml.KeyInfo;
