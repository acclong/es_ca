...
{
    public partial class DALQuanTri_Public
    {
        ...
        /// </summary>
        public DALQuanTri_Public(string strConn)
        {
        ...
        /// Constructs new SqlDataProvider instance with specific connection
        /// </summary>
        public DALQuanTri_Public(string sComputerName, string sDBName, string sUserName, string sPassword)
        {
