...
{
    public partial class BUSQuanTri_Public
    {
        private DALQuanTri_Public _dal;

        #region Constructor
        /// <summary>
        /// Khởi tạo dùng kết nối mặc định
        /// </summary>
        public BUSQuanTri_Public()
        {
            _dal = new DALQuanTri_Public();
        }
        ...
        public BUSQuanTri_Public(string strConn)
        {
            _dal = new DALQuanTri_Public(strConn);
        }
        ...
        public BUSQuanTri_Public(string sComputerName, string sDBName, string sUserName, string sPassword)
        {
            _dal = new DALQuanTri_Public(sComputerName, sDBName, sUserName, sPassword);
        }
        #endregion
