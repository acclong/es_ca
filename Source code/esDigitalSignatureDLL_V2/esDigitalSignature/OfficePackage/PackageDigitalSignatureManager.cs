...
namespace esDigitalSignature.OfficePackage
{
    ...
    /// </summary>
    internal enum CertificateEmbeddingOption : int
    {
        /// <summary>
    ...
    internal delegate void InvalidSignatureEventHandler(object sender, SignatureVerificationEventArgs e);

    /// <summary>
    /// Signature Verification Event Args - information about a verification event
    /// </summary>
    internal class SignatureVerificationEventArgs : EventArgs
    {
        //------------------------------------------------------
        //
        //  Public Members
    ...
    /// </summary>
    internal sealed class PackageDigitalSignatureManager
    {
        ...
        public String HashAlgorithm
        {
            ...
            set
            {
                ...
                if (value == String.Empty)
                    throw new ArgumentException("UnsupportedHashAlgorithm", "value");
        ...
        public String TimeFormat
        {
            ...
            set
            {
                ...
                if (XmlSignatureProperties.LegalFormat(value))
                    ...
                    throw new FormatException("BadSignatureTimeFormatString");
            }
        }
        ...
        /// <summary>
        /// Type of signature relationship
        /// </summary>
        /// <value></value>
        static public String OriginToSignatureRelationshipType
        {
            get
            {
                return _originToSignatureRelationshipType;
            }
        }

        /// <summary>
        /// Toantk: Type of extended-properties relationship
        /// </summary>
        /// <value></value>
        static public String ExtendedPropertiesRelationshipType
        {
            get
            {
                return _extendedPropertiesRelationshipType;
            }
        }

        /// <summary>
        /// Toantk: Type of core-properties relationship
        /// </summary>
        /// <value></value>
        static public String CorePropertiesRelationshipType
        {
            get
            {
                return _corePropertiesRelationshipType;
            }
        }
            ...
            String signatureId)
        {
            ...
            {
                throw new ArgumentException("NothingToSign");
            }
        ...
        {
            if (ReadOnly)
                throw new InvalidOperationException("CannotSignReadOnlyFile");
            ...
            if (_container.PartExists(newSignaturePartName))
                throw new ArgumentException("DuplicateSignature");
...
#pragma warning restore 6506
        ...
        {
            // use default signature Id
            return Sign(parts, certificate, relationshipSelectors, XTable.Get(XTable.ID.OpcSignatureAttrValue), providerHSM);
        }
            ...
            HSMServiceProvider providerHSM)
        {
            ...
            return Sign(parts, certificate, relationshipSelectors, signatureId, providerHSM, null, null);
        }
...
#pragma warning disable 6506
            ...
            try
            {
                ...
                // do the actual signing - only Xml signatures currently supported
                signature = XmlDigitalSignatureProcessor.Sign(this, newSignaturePart, parts, relationshipSelectors, exSigner, signatureId, embedCertificateInSignaturePart,
                    providerHSM, signatureObjects, objectReferences);
            }
            catch (InvalidOperationException)
            {
                // bad hash algorithm - revert changes
...
#pragma warning restore 6506
        ...
        //-------------- Get Hash -------------//
        /// <summary>
        /// Get hash of parts from file
        /// </summary>
        /// <param name="parts">list of parts to hash - may be empty or null</param>
        /// <param name="relationshipSelectors">relationshipSelectors that hold information about 
        /// the relationships to be hash - may be empty or null</param>
        /// <returns></returns>
        [SecurityCritical]
        public byte[] GetHashValue(
            ...
            IEnumerable<PackageRelationshipSelector> relationshipSelectors)
        {
            // do the actual hash value - only Xml currently supported
            return XmlDigitalSignatureProcessor.GetHashValue(this, parts, relationshipSelectors);
        }
        #endregion
        #endregion
        ...
        public PackageDigitalSignature Countersign()
        {
            ...
            if (!IsSigned)
                throw new InvalidOperationException("NoCounterSignUnsignedContainer");
        ...
        public PackageDigitalSignature Countersign(X509Certificate certificate, IEnumerable<Uri> signatures)
        {
            ...
            foreach (Uri uri in signatures)
            {
                ...
                if (!part.ValidatedContentType.AreTypeAndSubTypeEqual(XmlDigitalSignatureProcessor.ContentType))
                    throw new ArgumentException("CanOnlyCounterSignSignatureParts: " + signatures.ToString());
            }
        ...
        {
            if (ReadOnly)
                throw new InvalidOperationException("CannotRemoveSignatureFromReadOnlyFile");
        ...
        static internal X509Certificate PromptForSigningCertificate(IntPtr hwndParent)
        {
            ...
            {
                // ask user to select
                collection = X509Certificate2UI.SelectFromCollection(collection, "CertSelectionDialogTitle", "CertSelectionDialogMessage", X509SelectionFlag.SingleSelection, hwndParent);
                if (collection.Count > 0)
                {
            ...
            if (parts != null)
            {
                foreach (Uri partUri in parts)
                {
                    if (!_container.PartExists(partUri))
                    {
                        ...
                        throw new ArgumentException("PartToSignMissing", "parts");
                    }
                }
            }
            ...
            IEnumerable<Reference> objectReferences)
        {
            ...
            if (signatureObjects != null)
            {
                ...
                foreach (DataObject obj in signatureObjects)
                {
                    ...
                    if (String.CompareOrdinal(obj.Id, XTable.Get(XTable.ID.OpcAttrValue)) == 0)
                        throw new ArgumentException("SignaturePackageObjectTagMustBeUnique", "signatureObjects");

                    // check for duplicates
                    //if (ids.Contains(obj.Id))
                    if (ids.Exists(new StringMatchPredicate(obj.Id).Match))
                        throw new ArgumentException("SignatureObjectIdMustBeUnique", "signatureObjects");
                    else
                        ids.Add(obj.Id);
                }
            }
            ...
            if ((signatureId != null) && (signatureId != String.Empty))
            {
                ...
                {
                    throw new ArgumentException("NotAValidXmlIdString: " + signatureId, "signatureId", xmlException);
                }
            }
        }
        ...
        private bool DeleteCertificateIfReferenceCountBecomesZeroVisitor(PackageRelationship r, Object context)
        {
            // don't resolve if external
            if (r.TargetMode != TargetMode.Internal)
                throw new FileFormatException("PackageSignatureCorruption");
                ...
                try
                {
                    ...
                    foreach (PackageRelationship r in containerRelationships)
                    {
                        ...
                        if (!_container.PartExists(targetUri))
                            throw new FileFormatException("SignatureOriginNotFound");
                        ...
                        if (p.ValidatedContentType.AreTypeAndSubTypeEqual(_originPartContentType))
                        {
                            ...
                            if (_originPartExists)
                                throw new FileFormatException("MultipleSignatureOrigins");
        ...
        //Toantk 12/8/2015
        private static Uri _defaultOriginPartName = PackUriHelper.CreatePartUri(new Uri("/_xmlsignatures/origin.sigs", UriKind.Relative));
        ...
        //Toantk 12/8/2015: sửa đường dẫn chứa chữ ký
        ...
        private static readonly String _defaultSignaturePartNamePrefix = "/_xmlsignatures/";
        private static readonly String _defaultSignaturePartNameExtension = ".xml";
        //Toantk 30/8/2015: thêm RelationshipType để loại khỏi PartsToBeSigned
        private static readonly String _extendedPropertiesRelationshipType = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/extended-properties";
        private static readonly String _corePropertiesRelationshipType = "http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties";
