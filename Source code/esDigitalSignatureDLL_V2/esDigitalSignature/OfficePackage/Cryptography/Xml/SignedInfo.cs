...
namespace esDigitalSignature.OfficePackage.Cryptography.Xml
{
    ...
    //using CryptoConfig = esDigitalSignature.OfficePackage.Cryptography.CryptoConfig;
        ...
        public Transform CanonicalizationMethodObject {
            get {
                if (m_canonicalizationMethodTransform == null) {
                    //TOANTK: m_canonicalizationMethodTransform = CryptoConfig.CreateFromName(this.CanonicalizationMethod) as Transform;
                    m_canonicalizationMethodTransform = Common.CreateTransformFromName(this.CanonicalizationMethod) as Transform;
                    if (m_canonicalizationMethodTransform == null)
