...
namespace esDigitalSignature.OfficePackage.Cryptography.Xml
{
    ...
    using SecurityResources = esDigitalSignature.OfficePackage.SecurityResources;
    ...
    internal class TransformChain {
        ...
        internal void LoadXml (XmlElement value) {
            ...
            for (int i = 0; i < transformNodes.Count; ++i) {
                ...
                //TOANTK: Transform transform = CryptoConfig.CreateFromName(algorithm) as Transform;
                Transform transform = Common.CreateTransformFromName(algorithm) as Transform;
                if (transform == null)
    ...
    [System.Security.Permissions.HostProtection(MayLeakOnAbort = true)]
    internal class XmlDsigC14NTransform : Transform {
