//-----------------------------------------------------------------------------
//
// <copyright file="PackagePart.cs" company="Microsoft">
...
namespace esDigitalSignature.OfficePackage
{
    ...
    /// </summary>
    internal abstract class PackagePart
    {
        //------------------------------------------------------
        //
        //  Public Constructors
            ...
            get
            {
                ...
                if (_contentType == null)
                {
                    ...
                    if (contentType == null)
                    {
                        ...
                        throw new InvalidOperationException("NullContentTypeProvided");
                    }
                    _contentType = new ContentType(contentType);
                }
        ...
        {
           throw new NotSupportedException("GetContentTypeCoreNotImplemented");
        }
        ...
        public Stream GetStream(FileMode mode, FileAccess access)
        {
            ...
            if (s == null)
                throw new IOException("NullStreamReturned");
        ...
        public PackageRelationship GetRelationship(string id)
        {
            ...
            if (returnedRelationship == null)
                throw new InvalidOperationException("PackagePartRelationshipDoesNotExist");
            else
        ...
        {
            if (!_container.InStreamingCreation)
                throw new IOException("MethodAvailableOnlyInStreamingCreation: CloseRelationships");
        ...
        private void ThrowIfOpenAccessModesAreIncompatible(FileMode mode, FileAccess access)
        {
            ...
            if(access == FileAccess.Read	&& 
                ...
                throw new IOException("UnsupportedCombinationOfModeAccess");
            ...
            if((_container.FileOpenAccess == FileAccess.Read && access != FileAccess.Read) ||
                ...
                throw new IOException("ContainerAndPartModeIncompatible");
        }
        ...
        {
            if (_container == null)
                throw new InvalidOperationException("ParentContainerClosed");
        }
        ...
        {
            if (_deleted == true)
                throw new InvalidOperationException("PackagePartDeleted");
        }
        ...
        private void ThrowIfRelationship()
        {
            if (IsRelationshipPart)
                throw new InvalidOperationException("RelationshipPartsCannotHaveRelationships");
        }
