//-----------------------------------------------------------------------------
//
// <copyright file="InternalRelationshipCollection.cs" company="Microsoft">
    ...
    internal class InternalRelationshipCollection : IEnumerable<PackageRelationship>
    {
        ...
        internal static void ThrowIfInvalidRelationshipType(string relationshipType)
        {
            ...
            if (relationshipType.Trim() == String.Empty)
                throw new ArgumentException("InvalidRelationshipType");
        }
                    ...
                    using (XmlCompatibilityReader reader = new XmlCompatibilityReader(baseReader, RelationshipKnownNamespaces))
                    {
                            ...
                            && (String.CompareOrdinal(PackagingUtilities.RelationshipNamespaceUri, reader.NamespaceURI) == 0))
                        {
                            ...
                            if (PackagingUtilities.GetNonXmlnsAttributeCount(reader) > 0)
                                throw new XmlException("RelationshipsTagHasExtraAttributes", null, reader.LineNumber, reader.LinePosition);
                            ...
                            while (reader.Read())
                            {
                                    ...
                                    && (String.CompareOrdinal(PackagingUtilities.RelationshipNamespaceUri, reader.NamespaceURI) == 0))
                                {
                                    ...
                                    else throw new XmlException("RelationshipTagDoesntMatchSchema", null, reader.LineNumber, reader.LinePosition);
                                }
                                else
                                    if (!(String.CompareOrdinal(RelationshipsTagName,reader.LocalName) == 0 && (reader.NodeType == XmlNodeType.EndElement)))
                                        throw new XmlException("UnknownTagEncountered", null, reader.LineNumber, reader.LinePosition);
                            }
                        }
                        else throw new XmlException("ExpectedRelationshipsElementTag", null, reader.LineNumber, reader.LinePosition);
                    }
                }
            }
        }
        ...
        private void ProcessRelationshipAttributes(XmlCompatibilityReader reader)
        {
            ...
            if (targetAttributeValue == null || targetAttributeValue == String.Empty)
                throw new XmlException("RequiredRelationshipAttributeMissing: " + TargetAttributeName, null, reader.LineNumber, reader.LinePosition);
            ...
            if (typeAttributeValue == null || typeAttributeValue == String.Empty)
                throw new XmlException("RequiredRelationshipAttributeMissing: " + TypeAttributeName, null, reader.LineNumber, reader.LinePosition);
            ...
            if (idAttributeValue == null || idAttributeValue == String.Empty)
                throw new XmlException("RequiredRelationshipAttributeMissing: " + IdAttributeName, null, reader.LineNumber, reader.LinePosition);
        ...
        private void ProcessEndElementForRelationshipTag(XmlCompatibilityReader reader)
        {
            ...
            if (reader.NodeType == XmlNodeType.EndElement && String.CompareOrdinal(RelationshipTagName, reader.LocalName) == 0)
                ...
                throw new XmlException("ElementIsNotEmptyElement: " + RelationshipTagName, null, reader.LineNumber, reader.LinePosition);
        }
        ...
        private PackageRelationship Add(Uri targetUri, TargetMode targetMode, string relationshipType, string id, bool parsing)
        {
            ...
            if (targetMode == TargetMode.Internal && targetUri.IsAbsoluteUri)
                throw new ArgumentException("RelationshipTargetMustBeRelative", "targetUri");
                    ...
                    || (targetUri.IsAbsoluteUri && targetUri.Scheme == PackUriHelper.UriSchemePack))
            {
                ...
                if (resolvedUri != null)
                {
                    if (PackUriHelper.IsRelationshipPartUri(resolvedUri))
                        throw new ArgumentException("RelationshipToRelationshipIllegal", "targetUri");
                }
            }
        ...
        private void ThrowIfIncorrectContentType(ContentType contentType)
        {
            if (!contentType.AreTypeAndSubTypeEqual(PackagingUtilities.RelationshipPartContentType))
                throw new FileFormatException("RelationshipPartIncorrectContentType");
        }
        ...
        private void ThrowIfXmlBaseAttributeIsPresent(XmlCompatibilityReader reader)
        {
            ...
            if (xmlBaseAttributeValue != null)
                throw new XmlException("InvalidXmlBaseAttributePresent: " + XmlBaseAttributeName, null, reader.LineNumber, reader.LinePosition);
        }
        ...
        {
            throw new XmlException("InvalidValueForTheAttribute: " + attributeName, ex, reader.LineNumber, reader.LinePosition);
        }
        ...
        private void ValidateUniqueRelationshipId(string id)
        {
            ...
            if (GetRelationshipIndex(id) >= 0)
                throw new XmlException("NotAUniqueRelationshipId: " + id);
        }
