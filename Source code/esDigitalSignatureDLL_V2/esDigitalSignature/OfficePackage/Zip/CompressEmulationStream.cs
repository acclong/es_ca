    ...
    internal class CompressEmulationStream : Stream
    {
        ...
        public override long Seek(long offset, SeekOrigin origin)
        {
            ...
            switch (origin)
            {
                ...
                default:
                    {
                        throw new ArgumentOutOfRangeException("origin", "SeekOriginInvalid");
                    }
            }
        ...
        internal CompressEmulationStream(Stream baseStream, Stream tempStream, long position, IDeflateTransform transformer)
        {
            ...
            if (!baseStream.CanSeek)
                throw new InvalidOperationException("SeekNotSupported");

            if (!baseStream.CanRead)
                throw new InvalidOperationException("ReadNotSupported");
