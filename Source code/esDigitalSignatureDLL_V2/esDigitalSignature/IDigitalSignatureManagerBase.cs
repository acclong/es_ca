...
namespace esDigitalSignature
{
    ...
    public interface IDigitalSignatureManagerBase : IDisposable
    {
        ...
        void Sign(X509Certificate2 certificate, int totalSign = 1, int position = 1);
        ...
        void Sign(X509Certificate2 certificate, HSMServiceProvider providerHSM, int totalSign = 1, int position = 1);
