...
namespace esDigitalSignature
{
    ...
    public class ESDigitalSignatureManager : IDisposable
    {
        ...
        /// <summary>
        /// Ký file bằng USB Token va dat chu ky vao vi tri 1 hoac 2 hoac 3
        /// </summary>
        /// <param name="certificate">Certificate ký</param>
        /// <returns></returns>
        public void Sign(X509Certificate2 certificate, int totalSign = 1, int position = 1)
        {
            _dsm.Sign(certificate, totalSign, position);
        }
        ...
        {
            _dsm.Sign(certificate, providerHSM, totalSign, position);
        }
