...
namespace esDigitalSignature.Library
{
    ...
    {
        /// <summary>
        /// NLDC ký lập (thường là nhân viên tạo văn bản)
        /// </summary>
        NLDCKyLap = 1,
        /// <summary>
        /// NLDC xác nhận (sử dụng chữ ký doanh nghiệp)
        /// </summary>
        NLDCXacNhan = 2,
        /// <summary>
        /// EPTC xác nhận
        ...
        DonViXacNhan = 4,
        /// <summary>
        /// NLDC ký kiểm tra (các văn bản không phải do A0 lập nhưng cần kiểm tra trước khi lãnh đạo phòng ký, ví dụ như xác nhận sự kiện trên trang web TTĐ)
        /// </summary>
        NLDCKyKiemTra = 5,
        /// <summary>
        /// NLDC ký duyệt (thường là cấp lãnh đạo phòng)
        /// </summary>
        NLDCKyDuyet = 6,
        /// <summary>
        /// Lãnh đạo NLDC ký (Giám đốc, phó giám đốc)
        /// </summary>
        NLDCKyLanhDao = 7,
        /// <summary>
        /// PC ký xác nhận
    ...
    public enum FileTypes
    {
        ...
        /// 
        /// </summary>
        SanLuongHopDongNMD_EPTC = 20,
        /// <summary>
        /// 
        /// </summary>
        SanLuongHopDongNMD_PC = 21,
        /// <summary>
        /// 
        /// </summary>
        ThuyVanPhucVuTinhQc = 22,
        /// <summary>
        /// 
        /// </summary>
        PhieuGNDN_NMD = 30,
        ...
        /// <summary>
        /// Bảng kê chênh lệch sản lượng VWEM tháng PC
        /// </summary>
        BangKeVWEM_BangKeChenhLechSanLuong_Thang = 52,

        BangKeVWEM_ChiPhiHopDongSaiKhac_Thang = 53,
        ...
        SuKienNhaMayGianTiepThiTruong = 104,

        SuKienNhaMayCungCapDichVuPhu = 105,
