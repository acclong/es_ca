...
using esDigitalSignature.iTextSharp.text.xml.simpleparser.handler;
/*
...
namespace esDigitalSignature.iTextSharp.text.xml.simpleparser {
    /**
    ...
    */
    internal sealed class SimpleXMLParser {
        /** possible states */
