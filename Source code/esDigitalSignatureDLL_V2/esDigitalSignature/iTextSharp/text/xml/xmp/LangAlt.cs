...
/*
 * $Id: LangAlt.cs 744 2014-05-15 17:11:29Z rafhens $
 * 
 *
...
namespace esDigitalSignature.iTextSharp.text.xml.xmp {
    [Obsolete]
    internal class LangAlt : Properties {
         ...
         * Add a language.
         */
        virtual public void AddLanguage(String language, String value) {
         ...
         * Process a property.
         */
        virtual protected internal void Process(StringBuilder buf, String lang) {
