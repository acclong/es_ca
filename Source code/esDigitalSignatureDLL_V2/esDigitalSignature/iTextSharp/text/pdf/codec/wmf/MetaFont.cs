...
/*
 * $Id: MetaFont.cs 744 2014-05-15 17:11:29Z rafhens $
 * 
 *
...
namespace esDigitalSignature.iTextSharp.text.pdf.codec.wmf {
    internal class MetaFont : MetaObject {
        ...
        virtual public BaseFont Font {
            get {
                if (font != null)
                    return font;
                esDigitalSignature.iTextSharp.text.Font ff2 = FontFactory.GetFont(faceName, BaseFont.CP1252, true, 10, ((italic != 0) ? esDigitalSignature.iTextSharp.text.Font.ITALIC : 0) | ((bold != 0) ? esDigitalSignature.iTextSharp.text.Font.BOLD : 0));
                font = ff2.BaseFont;
                if (font != null)
                    return font;
                string fontName;
