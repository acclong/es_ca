...
using System;
using System.Text;
using esDigitalSignature.iTextSharp.text.pdf.languages;

namespace esDigitalSignature.iTextSharp.text.pdf.languages {
     ...
     */
    internal abstract class IndicLigaturizer : ILanguageProcessor {
