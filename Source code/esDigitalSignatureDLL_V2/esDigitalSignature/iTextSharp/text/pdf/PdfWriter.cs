...
using System.util;
using esDigitalSignature.iTextSharp.text.log;
using esDigitalSignature.iTextSharp.text.pdf.events;
using esDigitalSignature.iTextSharp.text.pdf.interfaces;
using esDigitalSignature.iTextSharp.text.pdf.intern;
using esDigitalSignature.iTextSharp.text.pdf.collection;
using esDigitalSignature.iTextSharp.text.xml.xmp;
using esDigitalSignature.iTextSharp.xmp.options;
using Org.BouncyCastle.X509;
using esDigitalSignature.iTextSharp.text.error_messages;
using esDigitalSignature.iTextSharp.xmp;
...
namespace esDigitalSignature.iTextSharp.text.pdf {
    ...
    */
    ...
    internal class PdfWriter : DocWriter, 
