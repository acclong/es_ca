...
namespace esDigitalSignature.iTextSharp.text.pdf.hyphenation {
    /**
    ...
    */
    internal class Hyphenator {
        ...
        private const String defaultHyphLocation = "esDigitalSignature.iTextSharp.text.pdf.hyphenation.hyph.";
