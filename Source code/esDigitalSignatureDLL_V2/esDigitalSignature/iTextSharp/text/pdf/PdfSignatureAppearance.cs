...
namespace esDigitalSignature.iTextSharp.text.pdf
{
     ...
     */
    internal class PdfSignatureAppearance {
        ...
        */
        ...
        virtual public PdfTemplate GetAppearance()
        {
            ...
            if (app[2] == null)
            {
                ...
                if (layer2Text == null)
                {
                    //Toantk 17/8/2016: thêm tên tổ chức
                    ...
                    if (x500name != null)
                    {
                        ...
                        organization = x500name.GetField("O");
                    }
                    if (name == null)
                        name = "";
                    buf.Append(name).Append(" - ");
                    if (organization != null)
                        buf.Append(organization).Append(" - ");
                    buf.Append("Ngày: ").Append(signDate.ToString("dd/MM/yyyy HH:mm:ss \"GMT\"zzz"));
                    if (reason != null)
