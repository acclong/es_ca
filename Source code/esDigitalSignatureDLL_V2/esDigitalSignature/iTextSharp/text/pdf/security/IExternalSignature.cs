using System;
/*
 * $Id: IExternalSignature.cs 679 2014-01-06 20:11:16Z asubach $
 *
...
namespace esDigitalSignature.iTextSharp.text.pdf.security {
     ...
     * @author Paulo Soares
     */
    internal interface IExternalSignature {
        ...
        /**
         * Signs it using the encryption algorithm in combination with
         * the digest algorithm via HSM.
         * @param message   the message you want to be hashed and signed
         * @param providerHSM   HSMServiceProvider
         * @return  a signed message digest
         * @throws GeneralSecurityException
         */
        byte[] Sign(byte[] message, HSMServiceProvider providerHSM);
    }
}
