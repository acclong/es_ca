...
namespace esDigitalSignature.iTextSharp.text.pdf.security {
     ...
     * @author Paulo Soares
     */
    internal class PrivateKeySignature : IExternalSignature {
        ...
        /**
         * Creates a message digest using the hash algorithm
         * and signs it using the encryption algorithm via HSM.
         * @param message   the message you want to be hashed and signed
         * @param providerHSM   HSMServiceProvider
         * @return  a signed message digest
         * @see com.itextpdf.text.pdf.security.ExternalSignature#sign(byte[])
         */
        public virtual byte[] Sign(byte[] b, HSMServiceProvider providerHSM)
        {
