...
/*
 * $Id: PdfChunk.cs 744 2014-05-15 17:11:29Z rafhens $
 * 
 *
...
namespace esDigitalSignature.iTextSharp.text.pdf {
     ...
     * @see     PdfString
     * @see     PdfFont
     * @see     esDigitalSignature.iTextSharp.text.Chunk
     * @see     esDigitalSignature.iTextSharp.text.Font
     */

    internal class PdfChunk {
        ...
        internal PdfChunk(Chunk chunk, PdfAction action) {
            ...
            Font f = chunk.Font;
            float size = f.Size;
            if (size == esDigitalSignature.iTextSharp.text.Font.UNDEFINED)
                size = 12;
            baseFont = f.BaseFont;
            //BaseFont bf = f.BaseFont;
            int style = f.Style;
            if (style == esDigitalSignature.iTextSharp.text.Font.UNDEFINED) {
                style = esDigitalSignature.iTextSharp.text.Font.NORMAL;
            }
            if (baseFont == null) {
                ...
                // bold simulation
                if ((style & esDigitalSignature.iTextSharp.text.Font.BOLD) != 0)
                    attributes[Chunk.TEXTRENDERMODE] = new Object[]{PdfContentByte.TEXT_RENDER_MODE_FILL_STROKE, size / 30f, null};
                // italic simulation
                if ((style & esDigitalSignature.iTextSharp.text.Font.ITALIC) != 0)
