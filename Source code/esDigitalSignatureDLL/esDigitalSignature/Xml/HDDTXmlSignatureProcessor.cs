...
{
    public class HDDTXmlSignatureProcessor
    {
        /// <summary>
        ...
        internal HDDTXmlSignatureProcessor(XmlDocument doc)
        {
        ...
        internal HDDTXmlSignatureProcessor(XmlDocument doc, XmlElement signature)
        {
            Invariant.Assert(doc != null);
        ...
        {
            // create
            HDDTXmlSignatureProcessor p = new HDDTXmlSignatureProcessor(doc);
