...
namespace esDigitalSignature.eToken
{
    public static partial class PKCS11
    {
        ...
        #region TOANTK
        //Additional values from SafeNet
        public const int CK_INVALID_HANDLE = 0;
        public const int CK_VENDOR_DEFINED = unchecked((int)0x80000000);
        public const int CKO_VENDOR_DEFINED = CK_VENDOR_DEFINED;
        public const int CKA_VENDOR_DEFINED = CK_VENDOR_DEFINED;
        public const int CKM_VENDOR_DEFINED = CK_VENDOR_DEFINED;

        public const int CKF_ADMIN_TOKEN = unchecked((int)0x10000000);

        public const int CKA_SLOT_ID = (CKA_VENDOR_DEFINED + 0x0151);
        public const int CKA_PRIME_BITS = 0x00000133;
        public const int CKA_IMPORT = (CKA_VENDOR_DEFINED + 0x012B);
        public const int CKA_EXPORTABLE = (CKA_VENDOR_DEFINED + 0x0129);
        public const int CKA_SIGN_LOCAL_CERT = (CKA_VENDOR_DEFINED + 0x0127);

        public const int CKO_SLOT = (CKO_VENDOR_DEFINED + 0x020B);
        public const int CKO_CERTIFICATE_REQUEST = (CKO_VENDOR_DEFINED + 0x0201);

        public const int CKM_ENCODE_PKCS_10 = (CKM_VENDOR_DEFINED + 0x952);
        public const int CKM_REPLICATE_TOKEN_RSA_AES = (CKM_VENDOR_DEFINED + 0x9e0);
