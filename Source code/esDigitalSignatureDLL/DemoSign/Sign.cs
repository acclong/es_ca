    ...
    public partial class Sign : Form
    {
        ...
        private void btnSign_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //    //foreach (string strPath in filePaths)
                //    //{
                //    //    using (PdfDigitalSignatureManager dsm = new PdfDigitalSignatureManager(strPath))
                //    //    {
                //    //        PdfSignatureField field = new PdfSignatureField(PdfSignatureField.PositionOffsetEnum.UpperRight, new Point(10, 130), 200, 50);
                //    //        dsm.SignPdfFile(strPath, cert, field);
                //    //    }
                //    //}
                ...
                //        using (PdfDigitalSignatureManager dsm = new PdfDigitalSignatureManager(strPath))
                //        {
                //            PdfSignatureField field = new PdfSignatureField(PdfSignatureField.PositionOffsetEnum.UpperRight, new Point(10, 70), 200, 50);
                //            dsm.Sign(strPath, cert, field, provider);
                //        }
                //    }
                //    //Đóng giao tiếp HSM
                //    provider.Logout();
                ...
                //    MessageBox.Show("Ký file thành công!", "Thông báo!", MessageBoxButtons.OK, MessageBoxIcon.Information);
                //}
                //else if (sTypeFile == ".docx" || sTypeFile == ".xlsx")
                //{
                ...
                //    //foreach (string strPath in filePaths)
                //    //{
                //    //    using (OfficeDigitalSignatureManager dsm = new OfficeDigitalSignatureManager(strPath))
                //    //    {
                //    //        dsm.Sign(strPath, cert);
                //    //    }
                //    //}
                ...
                //        using (OfficeDigitalSignatureManager dsm = new OfficeDigitalSignatureManager(strPath))
                //        {
                //            dsm.Sign(strPath, cert, provider);
                //        }
                //    }
                //    //Đóng giao tiếp HSM
                //    provider.Logout();
                ...
                //    textBox1.Text += Environment.NewLine + "Total: " + (t3 - t1).TotalMilliseconds.ToString();
                ...
                //    //foreach (string strPath in filePaths)
                //    //{
                //    //    using (XmlDigitalSignatureManager dsm = new XmlDigitalSignatureManager(strPath))
                //    //    {
                //    //        dsm.Sign(strPath, cert);
                //    //    }
                //    //}
        ...
        private void btnVerify_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //{
                //    // Verify file PDF
                //    PdfDigitalSignatureManager dsm = new PdfDigitalSignatureManager(txtPath.Text);
                //    VerifyResult s = dsm.VerifySignatures();
                //    List<ESignature> lst = dsm.Signatures;
                //    dsm.Dispose();
                ...
                //    //VerifyResult s = odsm.VerifySignatures(txtPath.Text);
                //    //List<ESignature> lst = odsm.VerifyAndGetAllSignatures(txtPath.Text);
                ...
                //        //Xác thực certificate
                //        X509ChainStatusFlags certificateStatus = X509ChainStatusFlags.NoError;
                //        bool isValid = lst[0].ValidateCertificate(out certificateStatus);
                ...
                //{
                //    // Verify file PDF
                //    XmlDigitalSignatureManager dsm = new XmlDigitalSignatureManager(txtPath.Text);
                //    VerifyResult s = dsm.VerifySignatures();
                //    List<ESignature> lst = dsm.Signatures;
